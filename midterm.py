...
'An argument is the value that are sent to the function when it is called and A parameter is the variable listed inside the parentheses in the function definition.'

# 2. In your own words, describe what each of the following errors means.
# Write your response using complete sentences.

# syntax error 
'it is something the computer dont understand.'
# type error 
'an error when an operation could not be performed'
# name error 
'use a variable that has not been defined or assigned a value.'

# 3. What function would I use if I wanted to convert an integer data type into 
# a string data type?
'to convert an integer date type into a strind data type you would need to use str()'
# 4. What function would I use if I wanted to change a float data type into a 
# an integer data type?
'the function i would use is int()'
...
'Assignment'
# == 
'this means that it is Equal'
# =!
'this means that it is Not equal'
