...
def countLimbs(animals, quantity):
    if animals == 'cow':
        quantity*4
        print(f'you have {limbs} cows limbs.')
    elif animals == 'chicken':
        quantity*2
        print(f'you have {limbs} chicken limbs.')
    elif animals == 'goat':
        quantity*4
        print(f'you have {limbs} goat limbs.')
    else:
        print('animal/ value not found. Please enter a correct value.')
countLimbs()
