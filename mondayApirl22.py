...
'the main goal is to turn lights on and off based on the room in the home'
...
'how far do i have to be to trun on the lights '
...
'read the info then start the one in the same order as the prompt is in '