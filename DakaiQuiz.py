...
# your name.
print('Dakai Smith-lockett')
#7. What is a function definition and a function call?
"A function is a block of code which only runs when it is called."
#8. Describe what each symbol means?

# = // single equal 
"it means that it is an assignment"
# == // double equal
"it means that it is equal to a operator"
# != // exclaimation equal
'not equal'
...
Bookbagitemslist = ["Books", "pencils", "erasers", "calculator", "paper"]
Bookbagitemsprice = [5, 6, 3, 15, 10,]
